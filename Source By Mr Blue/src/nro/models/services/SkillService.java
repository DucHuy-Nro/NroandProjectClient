        ...
        switch (player.playerSkill.skillSelect.template.id) {
            case Skill.KAIOKEN:
                ...
                if (player.setClothes.thanVuTruKaio == 4) {
                    hpUse = (long) player.nPoint.hpMax / 100 * 5;
                } else if (player.setClothes.thanVuTruKaio == 5) {
                    hpUse = (long) player.nPoint.hpMax / 100 * 3;
                }
                ...
                try {
                    ...
                    if (plAtt.isBoss && !(plAtt instanceof Broly || plAtt instanceof SuperBroly)) {
                        if (damePST > plAtt.nPoint.hpMax / 100) {
                            ...
                            damePST = (int) ((long) plAtt.nPoint.hpMax / 100 - giamdame);
                        }
                    }
    ...
    public boolean canUseSkillWithMana(Player player) {
        ...
        if (skill != null && skill.template != null) {
            ...
            switch (skill.template.manaUseType) {
                ...
                case 1 -> {
                    long mpUse = (long) player.nPoint.mpMax * skill.manaUse / 100;
