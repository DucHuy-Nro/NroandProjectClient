                    ...
                    case 31:
                        {
                            ...
                            if (b15 == 1)
                            {
                                ...
                                Char char3 = GameScr.findCharInMap(num18);
                                char3.petFollow = new PetFollow();
                                char3.petFollow.smallID = smallID;
                                if (b16 > 0)
                                {
                                    char3.petFollow.SetImg(b16, array, wimg, himg);
                                }
                            }
                            ...
                            {
                                Char char4 = GameScr.findCharInMap(num18);
                    ...
                    case 52:
                        {
                            ...
                            if (b21 == 0)
                            {
                                ...
                                {
                                    Char char6 = GameScr.findCharInMap(num27);
                                    if (char6 != null)
                                    {
                    ...
                    case -103:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Char char2 = (Char)GameScr.vCharInMap.elementAt(num17);
                                    if (char2 != null && char2.cFlag == b14)
                                    {
